...
var Qpost_temp_Student = (object, cb) => {
    return myQuery("INSERT INTO Temp_Student (Student_name,Student_num, Birth_date, " +
        "ID_num, ID_expire_date, tax_num, Drive_license_num, Obs, School_Permit, " +
        "Student_license,Expiration_date,exam_expiration_date, Reservation_idReservation,Type_category_idType_category, "+
